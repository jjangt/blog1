     ...
     <div id="buttons" style="float:right">
     	<c:choose>
     		<c:when test="${loginUser.getId() == freeBoardVO.m_id }">
		     	<input type="button" value="수정하기" class="submit" onclick="free_go_mod('${freeBoardVO.fseq}')">
		     	<input type="button" value="삭제하기" class="submit" onclick="free_delete('${freeBoardVO.fseq}')">
