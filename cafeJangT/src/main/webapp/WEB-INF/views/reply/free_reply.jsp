                ...
                <table class="table">                    
                    <tr>
                        <td>
                            ...
                            <br>
                            <div>
                                <a href='javascript:void(0)' onClick="return save_comment('${freeBoardVO.fseq }')" class="btn pull-right btn-success">등록</a>
                            </div>
                        </td>
                    </tr>
                </table>
			...
			if(data.length > 0) {
				for(i=0; i<data.length; i++) {
					if(data[i].a_id != null) {
						...
						html += "&nbsp;<span id=\"write_date\">" + displayTime(data[i].regdate) + "</span><br>"
