...
<article>
    ...
    <table id="notice">
      <tr>
      	<th>제목</th>
		<td colspan="3">${imgBoardVO.subject}</td>
        <th>작성자</th>
        <c:choose>
    ...
    <div class="clear"></div>
     <div id="buttons" style="float:right">
     	<c:choose>
     		<c:when test="${loginUser.getId() == imgBoardVO.m_id }">
		     	<input type="button" value="수정하기" class="submit" onclick="img_go_mod('${imgBoardVO.ibseq}')">
		     	<input type="button" value="삭제하기" class="submit" onclick="img_delete('${imgBoardVO.ibseq}')">
