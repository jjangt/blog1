	...
	<form name="formm" method="post">
				...
				<c:otherwise>
					<c:forEach items="${imgBoardList}" var="imgBoardVO">
						<tr>
							...
							<td>
								<a href="img_board_view?ibseq=${imgBoardVO.ibseq}" style="text-decoration: none; font-weight:bold;" class="img_title">
									<span class="thum">
		...
		<div id="buttons" style="float: right">
			<input type="button" value="글쓰기" class="submit"
				onclick="location.href='img_board_write_form'"> <input
