...
<article>
    ...
    <div class="clear"></div>
     <div id="buttons" style="float:right">
     	<input type="button" value="삭제하기" class="submit" onclick="admin_free_delete('${freeBoardVO.fseq}')">
     	<input type="button"  value="목록보기" class="submit"  onclick="location.href='admin_free_board_list'"> 
